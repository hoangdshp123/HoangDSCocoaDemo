...
- (BOOL)resumeExternalUserAgentFlowWithURL:(NSURL *)URL {
  ...
  NSURL *newURL;
    newURL = [[NSURL alloc] initWithString: [URL.absoluteString stringByReplacingOccurrencesOfString: @"viettelpost://oauthredirect#" withString: @"viettelpost://oauthredirect?"]];
    
  OIDURLQueryComponent *query = [[OIDURLQueryComponent alloc] initWithURL:newURL];
  ...
  if (!error) {
    ...
    //MARK: -- Sửa lib trả về accessToken
