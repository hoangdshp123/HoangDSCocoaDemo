Pod::Spec.new do |s|
  ...
  s.platform     = :ios, "9.0"
  s.source       = { :git => "https://github.com/hoangdshp123/HoangDSCocoaDemo.git", :tag => "1.1.3" }
  s.source_files = "HoangDSCocoaDemo/**/*"
  s.subspec 'Resources' do |resources|
      resources.resource_bundle = {'HoangDSCocoaDemo' => ['HoangDSCocoaDemo/**/*.{png,storyboard}']}
  end
  s.swift_version = '5.0'
  ...
  s.dependency 'HoangDSCocoaDemo/Resources' ~> '1.1.3'
end
